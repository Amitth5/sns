...
function transactionCalculate(){
    ...
    con.query("SELECT * FROM orders INNER JOIN accept_deliveries ON orders.id = accept_deliveries.order_id WHERE DATE(orders.`created_at`) = '2022-08-01' AND orderstatus_id = 5", function (err, result, fields) {
